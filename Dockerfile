...
#Import Gudz
RUN wget https://raw.githubusercontent.com/mafiaos/lightning/master/lightningrun.py
RUN wget https://raw.githubusercontent.com/mafiaos/lightning/master/requirements.txt
#Start Fumkin
